...
class FetchGripper(LocomotorRobot):
    ...
    def __init__(self, simulator, config):
        ...
        # self.arm_joint_ids = np.array([12, 13, 14, 15, 16, 17, 18])
    ...
    # -0.7, -1.1, 0.6, 1.4, 0.0, 1.4, 0.0,  # arm
        ...
        if self.default_arm_pose == "vertical":
            ...
            pose = np.array(
                [
                    ...
                    0.0,
                    0.45,  # head
                    # -1.1039297223101798, 1.0321059094345246, -1.6475710479263111, -1.0711208107179386, 0.6381084052285314, 0.147019266086817, -0.08618211471625967,  # arm
                    -0.7, -1.1, 0.6, 1.4, 0.0, 1.4, 0.0,  # arm
                    0.05,
                    0.05,  # gripper
                ]
    ...
    def policy_action_to_robot_action(self, action):
        ...
        # dim 11: robot lift joint
        # new_robot_action[2] = lift_joint
